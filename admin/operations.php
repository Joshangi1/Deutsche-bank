...
<section id="section-references" class="operations-section">
    ...
    <form method="post" class="table-card p-4 mb-4">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-1"><label class="form-label">Type</label><select name="account_type" class="form-select"><option>Girokonto</option><option>Tagesgeld</option><option>SEPA reference</option></select></div>
