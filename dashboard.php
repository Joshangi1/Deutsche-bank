...
if ($bankingRegion === 'us') {
    $ui = [
        ...
        'hero_eyebrow' => 'Welcome to Deutsche Bank', 'hero_title' => 'Your U.S. checking account is ready',
    ...
    $ui = [
        ...
        'verification' => 'Verification status', 'review' => 'Current account review', 'quick' => 'Quick access',
        'link_card' => 'Add Credit Card', 'statements' => 'Statements', 'security' => 'Security',
        'hero_eyebrow' => 'Welcome to Deutsche Bank Canada', 'hero_title' => 'Your Canadian chequing account is ready',
    ...
    $ui = [
        ...
        'verification' => 'Verification status', 'review' => 'Current account review', 'quick' => 'Quick access',
        'link_card' => 'Add Credit Card', 'statements' => 'Statements', 'security' => 'Security',
        'hero_eyebrow' => 'Welcome to Deutsche Bank UK', 'hero_title' => 'Your UK current account is ready',
    ...
    $ui = [
        ...
        'verification' => 'Verification status', 'review' => 'Current account review', 'quick' => 'Quick access',
        'link_card' => 'Add Credit Card', 'statements' => 'Statements', 'security' => 'Security',
        'hero_eyebrow' => 'Welcome to Deutsche Bank Switzerland', 'hero_title' => 'Your Swiss private account is ready',
    ...
    $ui = [
        ...
        'hero_eyebrow' => 'Willkommen bei Deutsche Bank', 'hero_title' => 'Ihr neues Girokonto ist bereit',
    ...
    $ui = [
        ...
        'verification' => 'Verification status', 'review' => 'Current account review', 'quick' => 'Quick access',
        'link_card' => 'Add Credit Card', 'statements' => 'Statements', 'security' => 'Security',
        'hero_eyebrow' => 'Welcome to Deutsche Bank', 'hero_title' => 'Your European current account is ready',
...
<div class="mobile-bank-app">
    ...
    <div class="bank-home-grid">
        ...
        <section class="bank-app-card desktop-insights-panel">
            <div class="section-title-row"><h3>Account Analytics</h3></div>
