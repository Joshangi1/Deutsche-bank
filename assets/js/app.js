    ...
    document.querySelectorAll('canvas[data-chart]').forEach(canvas => {
        ...
        new Chart(canvas, {
            ...
            data: type === 'doughnut'
                ...
                : { labels: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun'], datasets: [{ label: 'Balance', data: [18200, 19400, 18850, 22100, 23600, 24800], borderColor: '#0052FF', backgroundColor: 'rgba(0,82,255,.14)', tension: .42, fill: true }] },
            options: {
                responsive: true,
                ...
                scales: type === 'doughnut' ? {} : {
                    ...
                    y: adminTheme ? { beginAtZero: false, grid: { color: 'rgba(0,82,255,.16)' }, ticks: { color: '#001E60' } } : { beginAtZero: false }
                }
            }
        });
    });
